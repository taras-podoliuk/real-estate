      ...
      <div className="relative">
        <div className="w-full h-48 relative">
          <Image
            ...
            sizes="(max-widht: 760px) 100vw, (max-width: 1200px) 50vw, 33vw"
        ...
        {showFavoriteButton && (
          <button
            className="absolute bottom-4 right-4 bg-white hover:bg-white/90 ronded-full p-2 cursor-pointer"
